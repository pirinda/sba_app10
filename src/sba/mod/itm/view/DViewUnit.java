...
public class DViewUnit extends DGridPaneView {
    ...
    public DViewUnit(DGuiClient client, String title) {
        super(client, DGridConsts.GRID_VIEW_TAB, DModConsts.IU_UNT, DLibConsts.UNDEFINED, title);
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT " +
                ...
                "FROM " + DModConsts.TablesMap.get(DModConsts.IU_UNT) + " AS v " +
    ...
    public void createGridColumns() {
        ...
        columns[col++] = new DGridColumnView(DGridConsts.COL_TYPE_TEXT_CODE_CAT, "v.cfd_unt_key", "Clave Unidad (SAT)");
        columns[col++] = new DGridColumnView(DGridConsts.COL_TYPE_DEC_8D, "v.rat_kg", "Equivalencia kg");
