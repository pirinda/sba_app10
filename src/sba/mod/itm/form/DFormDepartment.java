...
public class DFormDepartment extends DBeanForm {
    ...
    public DFormDepartment(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.IU_DEP, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    private void initComponentsCustom() {
        int lenCode = ((DDbConfigCompany) miClient.getSession().getConfigCompany()).getLengthCodeDepartment();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        boolean isCodeApplying = ((DDbConfigCompany) miClient.getSession().getConfigCompany()).isCodeDepartmentApplying();
