 ...
 */
public class DFormComponent extends DBeanForm {

    private DDbComponent moRegistry;

    /** Creates new form DFormComponent */
    public DFormComponent(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.IU_CMP, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    private void initComponentsCustom() {
        int lenCode = ((DDbConfigCompany) miClient.getSession().getConfigCompany()).getLengthCodeComponent();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        boolean isCodeApplying = ((DDbConfigCompany) miClient.getSession().getConfigCompany()).isCodeComponentApplying();

        moRegistry = (DDbComponent) registry;
    ...
    @Override
    public DDbComponent getRegistry() throws Exception {
        DDbComponent registry = moRegistry.clone();
