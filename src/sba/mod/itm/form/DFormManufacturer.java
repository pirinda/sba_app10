 ...
 */
public class DFormManufacturer extends DBeanForm {

    private DDbManufacturer moRegistry;

    /** Creates new form DFormManufacturer */
    public DFormManufacturer(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.IU_MFR, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    private void initComponentsCustom() {
        int lenCode = ((DDbConfigCompany) miClient.getSession().getConfigCompany()).getLengthCodeManufacturer();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        boolean isCodeApplying = ((DDbConfigCompany) miClient.getSession().getConfigCompany()).isCodeManufacturerApplying();

        moRegistry = (DDbManufacturer) registry;
        ...
        moTextCode.setEnabled(isCodeApplying);

        addAllListeners();
    }

    @Override
    public DDbManufacturer getRegistry() throws Exception {
        DDbManufacturer registry = moRegistry.clone();
