 ...
 */
public class DFormBrand extends DBeanForm {

    private DDbBrand moRegistry;

    /** Creates new form DFormBrand */
    public DFormBrand(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.IU_BRD, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    private void initComponentsCustom() {
        int lenCode = ((DDbConfigCompany) miClient.getSession().getConfigCompany()).getLengthCodeBrand();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        boolean isCodeApplying = ((DDbConfigCompany) miClient.getSession().getConfigCompany()).isCodeBrandApplying();

        moRegistry = (DDbBrand) registry;
    ...
    @Override
    public DDbBrand getRegistry() throws Exception {
        DDbBrand registry = moRegistry.clone();
