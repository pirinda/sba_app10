 ...
 */
public class DFormRoute extends DBeanForm {

    private DDbRoute moRegistry;

    /** Creates new form DFormRoute */
    public DFormRoute(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.MU_ROU, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    @Override
    public DDbRoute getRegistry() throws Exception {
        DDbRoute registry = moRegistry.clone();
