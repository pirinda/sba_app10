 ...
 */
public class DFormAgentType extends DBeanForm {

    private DDbAgentType moRegistry;

    /** Creates new form DFormAgentType */
    public DFormAgentType(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.MU_AGT_TP, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        moRegistry = (DDbAgentType) registry;
    ...
    public DDbAgentType getRegistry() throws Exception {
        DDbAgentType registry = moRegistry.clone();
