 ...
 */
public class DFormChannel extends DBeanForm {

    private DDbChannel moRegistry;

    /** Creates new form DFormChannel */
    public DFormChannel(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.MU_CHA, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        moRegistry = (DDbChannel) registry;
    ...
    @Override
    public DDbChannel getRegistry() throws Exception {
        DDbChannel registry = moRegistry.clone();
