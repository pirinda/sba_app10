 ...
 */
public class DDbCustomerType extends DDbRegistryUser {
    ...
    */
    ...
    public DDbCustomerType() {
        super(DModConsts.MU_CUS_TP);
        initRegistry();
    }
    ...
    public String getSqlWhere() {
        return "WHERE id_cus_tp = " + mnPkCustomerTypeId + " ";
    }

    @Override
    public String getSqlWhere(int[] pk) {
        return "WHERE id_cus_tp = " + pk[0] + " ";
    }
    ...
    public void computePrimaryKey(DGuiSession session) throws SQLException, Exception {
        ...
        msSql = "SELECT COALESCE(MAX(id_cus_tp), 0) + 1 FROM " + getSqlTable();
        resultSet = session.getStatement().executeQuery(msSql);
        if (resultSet.next()) {
            mnPkCustomerTypeId = resultSet.getInt(1);
        }
    }
    ...
    public void read(DGuiSession session, int[] pk) throws SQLException, Exception {
        ...
        if (!resultSet.next()) {
            ...
            mnPkCustomerTypeId = resultSet.getInt("id_cus_tp");
    ...
    @Override
    public DDbCustomerType clone() throws CloneNotSupportedException {
        DDbCustomerType registry = new DDbCustomerType();

        registry.setPkCustomerTypeId(this.getPkCustomerTypeId());
