 ...
 */
public class DViewPromoPackageCustomer extends DGridPaneView {

    public DViewPromoPackageCustomer(DGuiClient client, String title) {
        super(client, DGridConsts.GRID_VIEW_TAB, DModConsts.M_PRM_CUS, DLibConsts.UNDEFINED, title);
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT " +
                ...
                "FROM " + DModConsts.TablesMap.get(DModConsts.M_PRM_CUS) + " AS v " +
                ...
                "ORDER BY vt.name, vt.id_lnk_cus_tp, " + DDbConsts.FIELD_NAME + ", v.id_ref_cus, p.name, p.code, p.id_prm ";
    }
    ...
    public void createGridColumns() {
        ...
        columns[col++] = new DGridColumnView(DGridConsts.COL_TYPE_TEXT_NAME_CAT_M, "p.name", DGridConsts.COL_TITLE_NAME + " paquete promocional");
        columns[col++] = new DGridColumnView(DGridConsts.COL_TYPE_TEXT_CODE_CAT, "p.code", DGridConsts.COL_TITLE_CODE + " paquete promocional");
