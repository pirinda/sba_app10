 ...
 */
public class DViewUser extends DGridPaneView {

    public DViewUser(DGuiClient client, String title) {
        super(client, DGridConsts.GRID_VIEW_TAB, DModConsts.CU_USR, DLibConsts.UNDEFINED, title);
        // NOTE: Users who have access to this view have unrestricted privileges on data.
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT " +
                "v.id_usr AS " + DDbConsts.FIELD_ID + "1, " +
                "'' AS " + DDbConsts.FIELD_CODE + ", " +
                "v.name AS " + DDbConsts.FIELD_NAME + ", " +
                "vt.id_usr_tp AS " + DDbConsts.FIELD_TYPE_ID + "1, " +
                ...
                "FROM " + DModConsts.TablesMap.get(DModConsts.CU_USR) + " AS v " +
                "INNER JOIN " + DModConsts.TablesMap.get(DModConsts.CS_USR_TP) + " AS vt ON " +
                "v.fk_usr_tp = vt.id_usr_tp " +
                "INNER JOIN " + DModConsts.TablesMap.get(DModConsts.CU_USR_CTM_TP) + " AS ut ON " +
                "v.fk_usr_ctm_tp = ut.id_usr_ctm_tp " +
    ...
    public void createGridColumns() {
        ...
        columns[col++] = new DGridColumnView(DGridConsts.COL_TYPE_TEXT_NAME_CAT_M, "ut.name", DGridConsts.COL_TITLE_TYPE + " propio");
    ...
    public void defineSuscriptions() {
        ...
        moSuscriptionsSet.add(DModConsts.CU_USR_CTM_TP);
    }
}
