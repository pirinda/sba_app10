 ...
 */
public class DViewCountry extends DGridPaneView {

    public DViewCountry(DGuiClient client, String title) {
        super(client, DGridConsts.GRID_VIEW_TAB, DModConsts.CS_CTY, DLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT " +
                "v.id_cty AS " + DDbConsts.FIELD_ID + "1, " +
                ...
                "FROM " + DModConsts.TablesMap.get(DModConsts.CS_CTY) + " AS v " +
                "INNER JOIN " + DModConsts.TablesMap.get(DModConsts.CU_USR) + " AS u ON " +
                "v.fk_usr = u.id_usr " +
                (sql.length() == 0 ? "" : "WHERE " + sql) +
                "ORDER BY v.name, v.id_cty ";
    }
