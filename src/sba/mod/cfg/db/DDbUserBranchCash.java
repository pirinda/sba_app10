 ...
 */
public class DDbUserBranchCash extends DDbRegistry implements DUtilBranchEntity, DGridRow {
    ...
    protected String msXtaCashName;
    protected boolean mbXtaDisabled;
    protected boolean mbXtaSelected;

    public DDbUserBranchCash() {
        super(DModConsts.CU_USR_CSH);
        initRegistry();
    }
    ...
    public void setXtaCashName(String s) { msXtaCashName = s; }
    ...
    public String getXtaCashName() { return msXtaCashName; }
    ...
    public int[] getPrimaryKey() {
        return new int[] { mnPkUserId, mnPkBizPartnerId, mnPkBranchId, mnPkCashId };
    }
    ...
    @Override
    public DDbUserBranchCash clone() throws CloneNotSupportedException {
        DDbUserBranchCash registry = new DDbUserBranchCash();
