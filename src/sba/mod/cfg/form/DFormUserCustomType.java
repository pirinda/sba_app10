 ...
 */
public class DFormUserCustomType extends DBeanForm {

    private DDbUserCustomType moRegistry;

    /** Creates new form DFormUserCustomType */
    public DFormUserCustomType(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.CU_USR_CTM_TP, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        moRegistry = (DDbUserCustomType) registry;
    ...
    @Override
    public DDbUserCustomType getRegistry() throws Exception {
        DDbUserCustomType registry = moRegistry.clone();
