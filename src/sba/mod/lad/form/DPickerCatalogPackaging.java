 ...
 */
public class DPickerCatalogPackaging extends DBeanFormDialog implements ActionListener, KeyListener {
    
    protected DGridPaneForm moGridOptions;
    protected ArrayList<DGridRow> maGridRows;

    /**
     * Creates new form DPickerPackaging
     */
    public DPickerCatalogPackaging(DGuiClient client) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, 0, 0, "Buscar embalaje");
        initComponents();
    ...
    private void initComponents() {
        ...
        moTextPackagingName = new sba.lib.gui.bean.DBeanFieldText();
        ...
        jlPackaging.setText("Empaque:");
        jlPackaging.setPreferredSize(new java.awt.Dimension(75, 23));
        jpParams2.add(jlPackaging);

        moTextPackagingName.setText("TEXT");
        moTextPackagingName.setPreferredSize(new java.awt.Dimension(400, 23));
        jpParams2.add(moTextPackagingName);

        moTextPackagingCode.setText("TEXT");
        moTextPackagingCode.setPreferredSize(new java.awt.Dimension(50, 23));
        jpParams2.add(moTextPackagingCode);
    ...
    private sba.lib.gui.bean.DBeanFieldText moTextPackagingName;
    ...
    private void actionPerformedClear() {
        moTextPackagingName.resetField();
        moTextPackagingCode.resetField();
        
        moTextPackagingName.requestFocus();
    }

    private void keyPressedPackagingCode(final KeyEvent event) {
    ...
    private void keyReleasedPackagingNameCode(final KeyEvent e) {
        String name = moTextPackagingName.getValue().toUpperCase();
        String code = moTextPackagingCode.getValue().toUpperCase();
        ...
        try {
            if (maGridRows == null) {
                ...
                if (maGridRows.isEmpty()) {
                    miClient.showMsgBoxWarning("No se encontraron embalajes.");
                }
            }
    ...
    public void addAllListeners() {
        ...
        moTextPackagingName.addKeyListener(this);
    ...
    public void removeAllListeners() {
        ...
        moTextPackagingName.removeKeyListener(this);
    ...
    public Object getValue(final int type) {
        ...
        switch (type) {
            case DLadCatalogConsts.MERCH_PACKAGING:
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getSource() instanceof DBeanFieldText) {
            ...
            if (field == moTextPackagingCode) {
                keyPressedPackagingCode(e);
            }
        }
    ...
    public void keyReleased(KeyEvent e) {
        if (e.getSource() instanceof DBeanFieldText) {
            ...
            if (field == moTextPackagingName || field == moTextPackagingCode) {
                keyReleasedPackagingNameCode(e);
            }
        }
    }
}
