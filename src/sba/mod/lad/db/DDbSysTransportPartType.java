...
public class DDbSysTransportPartType extends DDbRegistrySys {
    ...
    */
    ...
    public String getSqlWhere() {
        return "WHERE id_tpt_part_tp = " + mnPkTypeId + " ";
    }

    @Override
    public String getSqlWhere(int[] pk) {
        return "WHERE id_tpt_part_tp = " + pk[0] + " ";
    }
    ...
    public void computePrimaryKey(DGuiSession session) throws SQLException, Exception {
        ...
        msSql = "SELECT COALESCE(MAX(id_tpt_part_tp), 0) + 1 "
                + "FROM " + getSqlTable();
    ...
    public void read(DGuiSession session, int[] pk) throws SQLException, Exception {
        ...
        if (!resultSet.next()) {
            ...
            mnPkTypeId = resultSet.getInt("id_tpt_part_tp");
