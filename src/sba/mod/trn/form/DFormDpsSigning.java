...
public class DFormDpsSigning extends DBeanForm {
    ...
    /** Creates new form DFormDpsSigning
     * @param client GUI client.
     */
    public DFormDpsSigning(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.T_DPS_SIG, DModSysConsts.TX_XMS_REQ_TP_SIG, title);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos del timbrado:"));
    ...
    public DDbDpsSigning getRegistry() throws Exception {
        ...
        DDbDpsSigning registry = moDps.createDpsSigning(false);
