 ...
 */
public class DFormSchedule extends DBeanForm {

    private DDbSchedule moRegistry;

    /** Creates new form DFormSchedule */
    public DFormSchedule(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.TU_SCH, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        moRegistry = (DDbSchedule) registry;
    ...
    @Override
    public DDbSchedule getRegistry() throws Exception {
        DDbSchedule registry = moRegistry.clone();
