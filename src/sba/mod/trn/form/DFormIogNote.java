 ...
 */
public class DFormIogNote extends DBeanForm {

    public static final int MAX_LENGTH = 255;

    private DDbIogNote moRegistry;

    /** Creates new form DFormDpsNote */
    public DFormIogNote(DGuiClient client, String title) {
        setFormSettings(client, DGuiConsts.BEAN_FORM_EDIT, DModConsts.T_IOG_NOT, DLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(DDbRegistry registry) throws Exception {
        moRegistry = (DDbIogNote) registry;
    ...
    @Override
    public DDbIogNote getRegistry() throws Exception {
        DDbIogNote registry = moRegistry.clone();
